...
namespace SociallyAnxiousHub.Authentication
{
    class SpotifyService
    {
        ...
        public async Task AuthenticateAsync()
        {
            ...
            {
                MathThread.BeginInvokeOnMainThread(() => { $"Failed Authenticating with Spotify: " throw ex.Message});
        ...
        public async Task<List<Song>> SearchSongsAsync(string query)
        {
            ...
            {
                MathThread.BeginInvokeOnMainThread(() => { $"Failed Searching for songs: " throw ex.Message});
